    ...
    <div class="tab-sec">
		<div class="tab">
			<button class="tablinks" onclick="vw_fitness_gym_open_tab(event, 'block_pattern')"><?php esc_html_e( 'Setup With Block Pattern', 'vw-fitness-gym' ); ?></button>
		  	<button class="tablinks" onclick="vw_fitness_gym_open_tab(event, 'fitness_lite')"><?php esc_html_e( 'Setup With Customizer', 'vw-fitness-gym' ); ?></button>		  
			...
			<div class="block-pattern-img">
				...
				<p><?php esc_html_e('Follow the below instructions to setup Home page with Block Patterns.','vw-fitness-gym'); ?></p>
	          	...
	          	<div class="vw-fitness-gym-pattern-page">
			    	<a href="<?php echo esc_url( admin_url( 'post-new.php?post_type=page' ) ); ?>" target="_blank" class="vw-pattern-page-btn button-primary button"><?php esc_html_e('Add New Page','vw-fitness-gym'); ?></a>
			    </div>
		...
		<div id="fitness_lite" class="tabcontent">
